...
| Level | Force Trigger | Output Type | Example Response |
| :-: | :-: | :-: | :-: |
...
Enforces compliance with California's two-party recording consent law (California Penal Code § 632).
  ...
  - **Trigger**: Smart geofencing (workplace coordinates detected) or workplace manually set.
