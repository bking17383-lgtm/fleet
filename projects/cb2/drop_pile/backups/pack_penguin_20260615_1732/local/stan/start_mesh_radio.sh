...
echo "  office: http://127.0.0.1:8765/office"
echo "  desk:   http://127.0.0.1:8765/desk"
echo "  status: http://127.0.0.1:8765/status"
echo "  log:    $LOG"
"${HOME}/.stan/start_mesh_radio_tunnel.sh" 2>/dev/null || echo "WARN: public tunnel failed — use Tailscale or re-run start_mesh_radio_tunnel.sh"
