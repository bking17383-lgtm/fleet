...
TYPO_WORD: list[tuple[re.Pattern[str], str, str]] = [
    (re.compile(r"\bADDY\b", re.I), "CPT", "ADDY→CPT"),
    (re.compile(r"\bDADY\b", re.I), "CPT", "DADY→CPT"),
    (re.compile(r"\bDADDY\b", re.I), "CPT", "DADDY→CPT (retired)"),
    (re.compile(r"\bCAPTIN\b", re.I), "CPT", "CAPTIN→CPT"),
    (re.compile(r"\bCAPTAN\b", re.I), "CPT", "CAPTAN→CPT"),
    (re.compile(r"\bCAPTAIN\b", re.I), "CPT", "CAPTAIN→CPT"),
    (re.compile(r"\bCAPTN\b", re.I), "CPT", "CAPTN→CPT"),
    (re.compile(r"\bWRANGLER\b", re.I), "STUDIO", "WRANGLER→STUDIO (retired)"),
    (re.compile(r"\bBEACON\b", re.I), "CPT", "BEACON→CPT (retired)"),
