...
app = Flask(__name__)
UPLOAD_FOLDER = "/mnt/shared/GoogleDrive/MyDrive/lester/uploaded_files"
    ...
    <div class="w-full max-w-lg bg-slate-800 p-8 rounded-2xl shadow-xl border border-slate-700">
        ...
        <div class="mt-8 border-t border-slate-700 pt-6">
            ...
            <div class="flex justify-between text-xs text-slate-300">
                ...
                <span class="font-mono text-slate-400">/mnt/shared/GoogleDrive/MyDrive/lester/uploaded_files</span>
            </div>
        </div>
    </div>
...
def upload_files():
    ...
    if uploaded_count > 0:
        return jsonify({
            "status": "success", 
            "message": f"Successfully uploaded {uploaded_count} file(s) to Puppy local directory!"
        }), 200
    else:
